...
public:
    ...
    void setupUi(QDialog *DialogToolRec)
    {
        ...
        DialogToolRec->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 211);\n"
...
"color:rgb(85, 85, 255);"));
    ...
    {
        DialogToolRec->setWindowTitle(QCoreApplication::translate("DialogToolRec", "\320\236\320\261 \320\243\321\202\320\270\320\273\320\270\321\202\320\260\321\205", nullptr));
