...
public:
    ...
    void setupUi(QDialog *DialogFileRec)
    {
        ...
        DialogFileRec->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 211);\n"
...
"color:rgb(85, 85, 255);"));
    ...
    {
        DialogFileRec->setWindowTitle(QCoreApplication::translate("DialogFileRec", "\320\236 \320\244\320\276\321\200\320\274\320\260\321\202\320\260\321\205", nullptr));
